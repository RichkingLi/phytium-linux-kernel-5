...
struct phytium_plane *phytium_primary_plane_create(struct drm_device *dev, int phys_pipe)
{
	...
	if (IS_X100(priv)) {
		phytium_plane->dc_hw_plane_get_format = x100_dc_hw_plane_get_primary_format;
		phytium_plane->dc_hw_update_dcreq = x100_dc_hw_update_dcreq;
		phytium_plane->dc_hw_update_primary_hi_addr = x100_dc_hw_update_primary_hi_addr;
		phytium_plane->dc_hw_update_cursor_hi_addr = NULL;
	}  else if (IS_E2000(priv)) {
		phytium_plane->dc_hw_plane_get_format = e2000_dc_hw_plane_get_primary_format;
		phytium_plane->dc_hw_update_dcreq = NULL;
		phytium_plane->dc_hw_update_primary_hi_addr = e2000_dc_hw_update_primary_hi_addr;
		phytium_plane->dc_hw_update_cursor_hi_addr = NULL;
	}
...
struct phytium_plane *phytium_cursor_plane_create(struct drm_device *dev, int phys_pipe)
{
	...
	if (IS_X100(priv)) {
		phytium_plane->dc_hw_plane_get_format = x100_dc_hw_plane_get_cursor_format;
		phytium_plane->dc_hw_update_dcreq = NULL;
		phytium_plane->dc_hw_update_primary_hi_addr = NULL;
		phytium_plane->dc_hw_update_cursor_hi_addr = NULL;
	} else if (IS_E2000(priv)) {
		phytium_plane->dc_hw_plane_get_format = e2000_dc_hw_plane_get_cursor_format;
		phytium_plane->dc_hw_update_dcreq = NULL;
		phytium_plane->dc_hw_update_primary_hi_addr = NULL;
		phytium_plane->dc_hw_update_cursor_hi_addr = e2000_dc_hw_update_cursor_hi_addr;
	}
